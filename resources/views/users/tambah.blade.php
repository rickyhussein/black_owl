                    ...
                    <div class="form-row">
                        ...
                        <div class="col">
                            ...
                            <select name="rt" id="rt" class="form-control @error('rt') is-invalid @enderror selectpicker" data-live-search="true">
                                ...
                                <option value="002" {{ '002' == old('rt') ? 'selected="selected"' : '' }}>002</option>
                                <option value="003" {{ '003' == old('rt') ? 'selected="selected"' : '' }}>003</option>
                            </select>
                            @error('rt')
                            <div class="invalid-feedback">
                                {{ $message }}
                        ...
                        <div class="col">
                            ...
                            <select name="status" id="status" class="form-control @error('status') is-invalid @enderror selectpicker" data-live-search="true">
                                ...
                                @foreach ($status as $stat)
                                    <option value="{{ $stat->status }}" {{ $stat->status == old('status') ? 'selected="selected"' : '' }}>{{ $stat->status }}</option>
                                @endforeach
                            </select>
                            @error('status')
                            <div class="invalid-feedback">
