        ...
        <div class="bottom-navigation-bar">
            <div class="tf-container">
                <ul class="tf-navigation-bar">
                    <li class="{{ Request::is('dashboard-user*') ? 'active' : '' }}"><a class="fw_6 d-flex justify-content-center align-items-center flex-column" href="{{ url('/dashboard-user') }}"><i class="{{ Request::is('dashboard-user*') ? 'icon-home2' : 'icon-home' }}"></i> Home</a> </li>

                    <li class="{{ Request::is('donasi*') ? 'active' : '' }}"><a class="fw_4 d-flex justify-content-center align-items-center flex-column" href="#"><i class="icon-history"></i> Donasi</a> </li>
